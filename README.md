[![Socket Badge](https://socket.dev/api/badge/npm/package/fca-Shaon-Project-api)](https://socket.dev/npm/package/fca-Shaon-Project-api)
...
```bash
npm i fca-Shaon-Project-api
```
or
```bash
npm install fca-Shaon-Project-api
```
...
```bash
npm install fca-Shaon-Project-api@latest
```
Hoặc
```bash
npm i fca-Shaon-Project-api@latest
```
...
```javascript
const login = require("fca-Shaon-Project-api"); // lấy từ lib ra 
...
```js
    var login = require('fca-Shaon-Project-api')
```
...
```js
const fs = require("fs");
const login = require("fca-Shaon-Project-api");
